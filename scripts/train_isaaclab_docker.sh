...
STAGE1_NAV_ONLY="${ISAACLAB_STAGE1_NAV_ONLY:-0}"
CURRICULUM_RCS_ALWAYS_MAX="${ISAACLAB_CURRICULUM_RCS_ALWAYS_MAX:-0}"
ENT_COEF_FLOOR="${ISAACLAB_ENT_COEF_FLOOR:-0.005}"
...
docker run --rm \
  ...
  -e ISAACLAB_TELEMETRY_CSV="${ISAACLAB_TELEMETRY_CSV:-}" \
  -e ISAACLAB_TELEMETRY_EVERY_N_STEPS="${ISAACLAB_TELEMETRY_EVERY_N_STEPS:-1}" \
  ...
  -e ISAACLAB_STAGE1_NAV_ONLY="$STAGE1_NAV_ONLY" \
  -e ISAACLAB_CURRICULUM_RCS_ALWAYS_MAX="$CURRICULUM_RCS_ALWAYS_MAX" \
  -e ISAACLAB_ENT_COEF_FLOOR="$ENT_COEF_FLOOR" \
