...
WATCH_POLICY_RCS_THRUST_N="${ISAACLAB_WATCH_POLICY_RCS_THRUST_N:-}"
...
DOCKER_ARGS=(
  ...
  -e ISAACLAB_TERRAIN_DETAIL_AMPLITUDE_MIN_M="${ISAACLAB_TERRAIN_DETAIL_AMPLITUDE_MIN_M:-}"
  -e ISAACLAB_TERRAIN_DETAIL_AMPLITUDE_MAX_M="${ISAACLAB_TERRAIN_DETAIL_AMPLITUDE_MAX_M:-}"
  ...
  -e ISAACLAB_WATCH_POLICY_RCS_THRUST_N="$WATCH_POLICY_RCS_THRUST_N"
